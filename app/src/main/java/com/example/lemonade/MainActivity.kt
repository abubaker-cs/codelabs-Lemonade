...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        // TODO 01: use a conditional statement like 'if' or 'when' to track the lemonadeState
        ...
        when (lemonadeState) {
            ...
            // When the image is clicked in the SQUEEZE state the
            // squeezeCount needs to be INCREASED by 1 and
